         ...
         ?>
            ...
            <div class="modal fade login-modalbox" tabindex="-1" role="dialog">
						<div class="th-login-modalbox">
							...
							<p><?php esc_html_e('Not a Member?' , 'law_core'); ?> <a class="register-me" href="javascript:;"><?php esc_html_e('Sign Up' , 'law_core'); ?></a></p>
						</div>
					</div>
            <!--Signup Form-->
			<div class="modal fade signup-modalbox" tabindex="-1" role="dialog">
                <div class="th-signup-modalbox th-login-modalbox">
                    ...
                    <p><?php esc_html_e('Already Member?' , 'law_core'); ?> <a class="login-me" href="javascript:;"><?php esc_html_e('Sign In' , 'law_core'); ?></a></p>
                </div>
            </div>
         <?php   
        }
