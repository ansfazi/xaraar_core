...
?>
<div class="container news-posts single-post-view">
    <div class="row">   
        <div class="<?php echo esc_attr($section_width); ?> <?php echo sanitize_html_class($content_class); ?>" id="content">
            ...
            while (have_posts()) : the_post();
                $thumnail = law_firm_prepare_thumbnail(get_the_ID() , 468 , 436);
                ...
                <div class="team-details-block row">
                    <div class="col-xs-12">
                        <article class="team-details">
                            ...
                            <div class="team-txt">
                                <header class="team-heading">
                                    ...
                                    <ul class="team-socials list-inline">
                                        <?php foreach ($social_icons as $social): ?>
                                            <li><a href="<?php echo esc_url($social['social_url']); ?>" target="_blank"><i class="<?php esc_attr_e($social['social_icons_list']) ?>"></i></a> </li>
                                        <?php endforeach; ?>
                                    </ul>
                                </header>
                                ...
                                <ul class="team-nav list-inline">
                                    <li><a class="tel" href="tel:<?php esc_attr_e($contact_number) ?>"><i class="fa fa-fax"></i><?php esc_attr_e($contact_number) ?></a></li>
                                    <li><a class="tel" href="tel:<?php esc_attr_e($contact_number_secondary) ?>"><i class="fa fa-phone-square"></i> <?php esc_attr_e($contact_number_secondary) ?></a></li>
                                </ul>
                                <p><?php the_content(); ?></p>
                ...
                <?php if (isset($education_block) && !empty($education_block)) { ?>
                    <div class="row education-block">
                        <article class="col-xs-12">
                            <h2><?php esc_html_e('Education' , 'law_core'); ?></h2>
                            <?php echo do_shortcode($education_block) ?>
                        </article>
                    </div>
                <?php } ?>
                <!-- team-info-section of the page -->
                <?php if (isset($list_blocks) && !empty($list_blocks)) { ?>
                ...
                <div class="row team-contact-block">
                    <div class="col-sm-7 col-xs-12 team-contact contact_wrap">
                        <h2><?php esc_html_e('Contact Me' , 'law_core'); ?></h2>
                        ...
                        <form action="javascript:;" class="comments-form contact_form" data-email="<?php esc_attr_e($email) ?>">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="username" class="form-control" id="name1" placeholder="<?php esc_attr_e('Name' , 'law_core'); ?>">
                                </div>
                                <div class="form-group">
                                    <label for="emailaddress"><i class="fa fa-envelope"></i></label>
                                    <input type="text" name="useremail" class="form-control" id="emailaddress" placeholder="<?php esc_attr_e('Email' , 'law_core'); ?>">
                                </div>
                                <div class="form-group">
                                    <label for="web"><i class="fa fa-dribbble"></i></label>
                                    <input type="text" name="subject" class="form-control" id="web" placeholder="<?php esc_attr_e('Subject' , 'law_core'); ?>">
                                </div>
                            </div>
                            <div class="form-row textarea">
                                <div class="form-group">
                                    <label for="textarea"><i class="fa fa-paper-plane"></i></label>
                                    <textarea class="form-control" name="description" cols="30" rows="10" id="textarea" placeholder="<?php esc_attr_e('Comment...' , 'law_core'); ?>"></textarea>
                                </div>
                            </div>
                            <?php wp_nonce_field('consult_with_me' , 'security'); ?>
                            <button type="submit" class="btn btn-default consult_with_me"><?php esc_html_e('Submit' , 'law_core'); ?></button>
                        </form>
                    </div>
